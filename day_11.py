...
def contar_ao_redor(procurar_tipo,posicoes_anterior,linhas,colunas,i_linha,i_coluna):
    ...
    if  i_coluna>0:
        if posicoes_anterior[i_linha][i_coluna-1] == procurar_tipo:
            ocupados+=1

    if  i_coluna<(colunas-1):
        if posicoes_anterior[i_linha][i_coluna+1] == procurar_tipo:
            ocupados+=1

    if i_linha>0:
        if posicoes_anterior[i_linha-1][i_coluna] == procurar_tipo:
            ocupados+=1
    ...
    if i_coluna>0 and i_linha>0:
        if posicoes_anterior[i_linha-1][i_coluna-1] == procurar_tipo:
            ocupados+=1
    if i_coluna<colunas-1 and i_linha>0:
        if posicoes_anterior[i_linha-1][i_coluna+1] == procurar_tipo:
            ocupados+=1

    if i_coluna>0 and i_linha<linhas-1:
        if posicoes_anterior[i_linha+1][i_coluna-1] == procurar_tipo:
            ocupados+=1

    if i_coluna<colunas-1 and i_linha<linhas-1:
        if posicoes_anterior[i_linha+1][i_coluna+1] == procurar_tipo:
            ocupados+=1
